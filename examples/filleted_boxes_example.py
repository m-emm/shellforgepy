...
def main():
    ...
    no_fillets = create_filleted_box(box_size, box_size, box_size, fillet_radius, fillets_at=[])
    parts.add(no_fillets, "no_fillets")
    
    # 3. Box with only top edges filleted
    top_only = create_filleted_box(box_size, box_size, box_size, fillet_radius, 
                                   fillets_at=[Alignment.TOP])
    parts.add(top_only, "top_edges_only")
    
    # 4. Box with only bottom edges filleted
    bottom_only = create_filleted_box(box_size, box_size, box_size, fillet_radius,
                                      fillets_at=[Alignment.BOTTOM])
    parts.add(bottom_only, "bottom_edges_only")
    
    # 5. Box with left and right edges filleted
    left_right = create_filleted_box(box_size, box_size, box_size, fillet_radius,
                                     fillets_at=[Alignment.LEFT, Alignment.RIGHT])
    parts.add(left_right, "left_right_edges")
    
    # 6. Box with front and back edges filleted
    front_back = create_filleted_box(box_size, box_size, box_size, fillet_radius,
    ...
    top_front_right = create_filleted_box(box_size, box_size, box_size, fillet_radius,
    ...
    large_small_fillet = create_filleted_box(box_size * 1.5, box_size * 1.5, box_size, 1.0)
    parts.add(large_small_fillet, "large_small_fillet")
    
    # 9. Small box with large fillet
    small_large_fillet = create_filleted_box(box_size * 0.7, box_size * 0.7, box_size, 4.0)
    parts.add(small_large_fillet, "small_large_fillet")
    
    # 10. Rectangular box with selective fillets
    rectangular = create_filleted_box(box_size * 1.8, box_size * 0.8, box_size,
                                      fillet_radius, fillets_at=[Alignment.TOP, Alignment.BOTTOM])
    parts.add(rectangular, "rectangular_top_bottom")
    
    # 11. Tall box with side fillets only
    tall_box = create_filleted_box(box_size, box_size, box_size * 1.5, fillet_radius,
    ...
    all_except_bottom = create_filleted_box(box_size, box_size, box_size, fillet_radius,
